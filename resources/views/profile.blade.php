  ...
  <main class="container mx-auto py-16 flex justify-center">
    <div class="flex gap-16">
      ...
      <div class="flex flex-col items-center">
        ...
        <h2 class="text-base font-medium mb-8">{{ $user->name ?? 'Username' }}</h2>
      ...
      <div class="w-[630px] border border-gray-200 bg-white p-10">
        ...
        <p class="text-sm text-gray-600 mb-8">Manage your profile information to control, protect, and secure your account.</p>
        ...
        <form id="profileForm" action="/profile/update" method="POST" enctype="multipart/form-data" class="flex">
          ...
          <div class="flex-1 pr-10">
            ...
            <div class="mb-6">
              <input type="tel" name="phone" placeholder="No. Handphone" value="{{ $user->phone ?? '' }}" required class="w-full py-2 px-3 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            </div>

            <div class="mb-6">
              <input type="text" name="address" placeholder="Address" value="{{ $user->address ?? '' }}" required class="w-full py-2 px-3 border border-gray-300 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            </div>
          </div>
