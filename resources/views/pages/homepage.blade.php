...
<body class="font-sans bg-gray-50 text-gray-900">
  ...
  <div class="max-w-7xl mx-auto px-4 mb-10">
    <div class="h-[28rem] bg-gray-800 text-white rounded-xl flex items-center justify-center bg-center bg-cover"
      ...
      <div class="text-center p-5">
        ...
        <a href="#" class="py-3 px-6 bg-red-600 text-white font-bold rounded-md hover:bg-red-700 transition">View Collection</a>
      </div>
    </div>
  </div>
